...
void Shine::RegistProperties ()
{
	...
	AddProperty("SpecularExponent_Bake", Object::PT_FLOAT, mSpecularExponentTemp);
}
//----------------------------------------------------------------------------
void Shine::OnPropertyChanged (const PropertyObject &obj)
{
	...
	else if ("SpecularExponent_Bake" == obj.Name)
	{
