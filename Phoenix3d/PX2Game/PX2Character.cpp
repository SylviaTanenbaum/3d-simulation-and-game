...
void Character::RegistProperties ()
{
	...
	AddProperty("HP", PT_INT, GetCurHP());
	AddProperty("BaseHPCurLevel", PT_INT, GetBaseHPCurLevel());

	AddProperty("AP", PT_INT, GetCurAP());
	AddProperty("BaseAPCurLevel", PT_INT, GetBaseAPCurLevel());
	AddProperty("WatchDistance", PT_FLOAT, GetWatchDistance());

	AddProperty("ScriptHandler_OnBeAffect", PT_STRING, GetScriptHandler_OnBeAffect());
	AddProperty("ScriptHandler_OnSucAffect", PT_STRING, GetScriptHandler_OnSucAffect());
	AddProperty("ScriptHandler_OnDie", PT_STRING, GetScriptHandler_OnDie());
}
//----------------------------------------------------------------------------
