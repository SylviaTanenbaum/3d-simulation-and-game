...
//----------------------------------------------------------------------------
void SkillStep::SaveToXMLNode (XMLNode nodeParent)
{
	XMLNode nodeClass = nodeParent.NewChild("Class");
	nodeClass.SetAttributeString("Type", "SkillStep");

	Gameable::SaveToXMLNode(nodeClass);

	XMLNode nodeProperty = nodeClass.NewChild("Property");
	nodeProperty.SetAttributeInt("Mode", GetMode());
	nodeProperty.SetAttributeFloat("Probability", GetProbability());
	nodeProperty.SetAttributeBool("IsSkillCallOverAtThisStep", IsSkillCallOverAtThisStep());
	nodeProperty.SetAttributeInt("SkillCallOverTimeType", (int)GetSkillCallOverTimeType());
	nodeProperty.SetAttributeFloat("SkillCallOverValue", GetSkillCallOverValue());
	nodeProperty.SetAttributeString("AnimName", GetAnimName());
	nodeProperty.SetAttributeString("SelfEffectFilename", GetSelfEffectFilename());
	nodeProperty.SetAttributeString("SelfEffectAnchor", GetSelfEffectAnchor());
	nodeProperty.SetAttributeFloat("SelfEffectTime", GetSelfEffectTime());
	nodeProperty.SetAttributeString("SelfPosEffectFilename", GetSelfPosEffectFilename());
	nodeProperty.SetAttributeString("SelfPosEffectAnchor", GetSelfPosEffectAnchor());
	nodeProperty.SetAttributeFloat("SelfPosEffectTime", GetSelfPosEffectTime());
	nodeProperty.SetAttributeString("TargetEffectFilename", GetTargetEffectFilename());
	nodeProperty.SetAttributeString("TargetEffectAnchor", GetTargetEffectAnchor());
	nodeProperty.SetAttributeFloat("TargetEffectTime", GetTargetEffectTime());
	nodeProperty.SetAttributeString("TargetPosEffectFilename", GetTargetPosEffectFilename());
	nodeProperty.SetAttributeFloat("TargetPosEffectTime", GetTargetPosEffectTime());
	nodeProperty.SetAttributeString("ScriptHandler_Leave", GetScriptHandler_Leave());
	nodeProperty.SetAttributeString("ScriptHandler_Enter", GetScriptHandler_Enter());
	
	if (mNextStep)
	{
		XMLNode nodeObject = nodeClass.NewChild("Object");
		nodeObject.SetAttributeString("RttiName", mNextStep->GetRttiType().GetName());

		mNextStep->SaveToXMLNode(nodeObject);
	}
}
//----------------------------------------------------------------------------
void SkillStep::LoadFromXMLNode (XMLNode node)
{
	...
	{
		mMode = (Mode)nodeProperty.AttributeToInt("Mode");
		SetProbability(nodeProperty.AttributeToFloat("Probability"));

		if (nodeProperty.HasAttribute("IsSkillCallOverAtThisStep"))
			SetSkillCallOverAtThisStep(nodeProperty.AttributeToBool("IsSkillCallOverAtThisStep"));

		if (nodeProperty.HasAttribute("SkillCallOverTimeType"))
			SetSkillCallOverTimeType((TimeType)nodeProperty.AttributeToInt("SkillCallOverTimeType"));

		if (nodeProperty.HasAttribute("SkillCallOverValue"))
			SetSkillCallOverValue(nodeProperty.AttributeToFloat("SkillCallOverValue"));

		SetAnimName(nodeProperty.AttributeToString("AnimName"));
		SetSelfEffectFilename(nodeProperty.AttributeToString("SelfEffectFilename"));
		SetSelfEffectAnchor(nodeProperty.AttributeToString("SelfEffectAnchor"));
		SetSelfEffectTime(nodeProperty.AttributeToFloat("SelfEffectTime"));
		SetSelfPosEffectFilename(nodeProperty.AttributeToString("SelfPosEffectFilename"));

		if (nodeProperty.HasAttribute("SelfPosEffectAnchor"))
		{
			SetSelfPosEffectAnchor(nodeProperty.AttributeToString("SelfPosEffectAnchor"));
		}

		SetSelfPosEffectTime(nodeProperty.AttributeToFloat("SelfPosEffectTime"));
		SetTargetEffectFilename(nodeProperty.AttributeToString("TargetEffectFilename"));
		SetTargetEffectAnchor(nodeProperty.AttributeToString("TargetEffectAnchor"));
		SetTargetEffectTime(nodeProperty.AttributeToFloat("TargetEffectTime"));
		SetTargetPosEffectFilename(nodeProperty.AttributeToString("TargetPosEffectFilename"));
		SetTargetPosEffectTime(nodeProperty.AttributeToFloat("TargetPosEffectTime"));

		if (nodeProperty.HasAttribute("ScriptHandler_Leave"))
			SetScriptHandler_Leave(nodeProperty.AttributeToString("ScriptHandler_Leave"));
		SetScriptHandler_Enter(nodeProperty.AttributeToString("ScriptHandler_Enter"));
	}
	else
	{
		assertion(false, "");
